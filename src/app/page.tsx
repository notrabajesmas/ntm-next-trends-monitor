...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg sm:text-xl font-bold text-white">NTM</h1>
            ...
            <div className="flex md:hidden items-center gap-2">
              <Select value={locale} onValueChange={handleLocaleChange}>
                <SelectTrigger className="w-[70px] bg-slate-800 border-slate-600 text-white text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-slate-800 border-slate-600">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 border-t border-slate-700/50 pt-4">
              <div className="flex flex-col gap-3">
                ...
                <Button 
                  variant="outline" 
                  className="border-slate-600 text-slate-300 hover:text-white justify-start"
                  onClick={() => {
      ...
      <section className="py-10 sm:py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-8 sm:mb-12 px-2">
            <div className="flex items-center gap-1.5 sm:gap-2 text-slate-400 text-sm sm:text-base bg-slate-800/50 px-3 py-1.5 rounded-full">
      ...
      <section className="px-2 sm:px-4 pb-12 sm:pb-16">
        <div className="container mx-auto">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-4 bg-slate-800/50 border border-slate-700/50 mb-4 sm:mb-8 h-auto p-1 gap-1">
              <TabsTrigger 
                value="scanner" 
      ...
      {/* Stats Section */}
      <section className="py-10 sm:py-16 px-4 bg-slate-800/30 border-t border-slate-700/50">
        <div className="container mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
            <div className="text-center p-3 sm:p-0">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">10K+</div>
              <div className="text-xs sm:text-sm md:text-base text-slate-400">{t.stats1}</div>
            </div>
            <div className="text-center p-3 sm:p-0">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">500+</div>
              <div className="text-xs sm:text-sm md:text-base text-slate-400">{t.stats2}</div>
            </div>
            <div className="text-center p-3 sm:p-0">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">2K+</div>
              <div className="text-xs sm:text-sm md:text-base text-slate-400">{t.stats3}</div>
            </div>
            <div className="text-center p-3 sm:p-0">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">98%</div>
              <div className="text-xs sm:text-sm md:text-base text-slate-400">{t.stats4}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="py-6 sm:py-8 px-4 border-t border-slate-700/50 bg-slate-900/80">
        <div className="container mx-auto">
